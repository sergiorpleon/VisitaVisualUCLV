...
public class CIntermediario {
  CentralActivity mContext;
  
  CIntermediario(CentralActivity paramCentralActivity) {
    this.mContext = paramCentralActivity;
  }
  
  private void sendMessage(String paramString1, String paramString2) {
    Intent intent = new Intent("my-event-c");
...
/* Location:              C:\Users\Usuario\Videos\Visita Virtual a la UCLV\classes-dex2jar.jar\\uclv\dte\visitavirtualalauclv\CIntermediario.class
