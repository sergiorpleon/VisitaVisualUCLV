...
public class CETAActivity extends AppCompatActivity {
  String lenguage = "es";
  ...
  private void crearDialogoSlider() {
    ...
    builder.setTitle(getString(R.string.title_activity_ceta));
    webView.loadUrl("file:///android_asset/slider/ceta_" + this.lenguage + ".html");
  ...
  protected void onCreate(Bundle paramBundle) {
    ...
    toolbar.setNavigationOnClickListener(new View.OnClickListener() {
          public void onClick(View param1View) {
            CETAActivity.this.onBackPressed();
          }
        });
    this.lenguage = (new Configuration(getResources().getConfiguration())).locale.getLanguage();
    toolbar = null;
    try {
      Bitmap bitmap1 = getBitmapFromAsset("slider/img/ceta/ceta.jpg");
      bitmap = bitmap1;
    ...
    ((FloatingActionButton)findViewById(R.id.fab)).setOnClickListener(new View.OnClickListener() {
          public void onClick(View param1View) {
            CETAActivity.this.crearDialogoSlider();
          }
        });
    ...
    webSettings.setJavaScriptEnabled(true);
    webSettings.setDomStorageEnabled(true);
    this.myBrowser.loadUrl("file:///android_asset/info/ceta.html");
  }
}


/* Location:              C:\Users\Usuario\Videos\Visita Virtual a la UCLV\classes-dex2jar.jar\\uclv\dte\visitavirtualalauclv\CETAActivity.class
