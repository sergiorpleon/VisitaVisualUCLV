...
public class FIEActivity extends AppCompatActivity {
  String lenguage = "es";
  ...
  private void crearDialogoSlider() {
    ...
    builder.setTitle(getString(R.string.title_activity_fie));
    webView.loadUrl("file:///android_asset/slider/electrica_" + this.lenguage + ".html");
  ...
  protected void onCreate(Bundle paramBundle) {
    ...
    setContentView(R.layout.activity_fie);
    Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar);
    setSupportActionBar(toolbar);
    toolbar.setNavigationIcon(android.support.v7.appcompat.R.drawable.abc_ic_ab_back_material);
    toolbar.setNavigationOnClickListener(new View.OnClickListener() {
          public void onClick(View param1View) {
            FIEActivity.this.onBackPressed();
          }
        });
    this.lenguage = (new Configuration(getResources().getConfiguration())).locale.getLanguage();
    toolbar = null;
    try {
      Bitmap bitmap1 = getBitmapFromAsset("slider/img/electrica/Electrica.jpg");
      bitmap = bitmap1;
    ...
    ((FloatingActionButton)findViewById(R.id.fab)).setOnClickListener(new View.OnClickListener() {
          public void onClick(View param1View) {
            FIEActivity.this.crearDialogoSlider();
          }
        });
    ...
    webSettings.setJavaScriptEnabled(true);
    webSettings.setDomStorageEnabled(true);
    this.myBrowser.loadUrl("file:///android_asset/info/fie.html");
  }
}


/* Location:              C:\Users\Usuario\Videos\Visita Virtual a la UCLV\classes-dex2jar.jar\\uclv\dte\visitavirtualalauclv\FIEActivity.class
