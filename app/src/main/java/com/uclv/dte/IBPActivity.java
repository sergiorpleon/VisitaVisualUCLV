...
public class IBPActivity extends AppCompatActivity {
  String lenguage = "es";
  ...
  private void crearDialogoSlider() {
    ...
    builder.setTitle(getString(R.string.title_activity_ibp));
    webView.loadUrl("file:///android_asset/slider/ibp_" + this.lenguage + ".html");
  ...
  protected void onCreate(Bundle paramBundle) {
    ...
    ((FloatingActionButton)findViewById(R.id.fab)).setOnClickListener(new View.OnClickListener() {
          public void onClick(View param1View) {
            IBPActivity.this.crearDialogoSlider();
          }
        });
    ...
    webSettings.setJavaScriptEnabled(true);
    webSettings.setDomStorageEnabled(true);
    this.myBrowser.loadUrl("file:///android_asset/info/ibp.html");
  }
}


/* Location:              C:\Users\Usuario\Videos\Visita Virtual a la UCLV\classes-dex2jar.jar\\uclv\dte\visitavirtualalauclv\IBPActivity.class
