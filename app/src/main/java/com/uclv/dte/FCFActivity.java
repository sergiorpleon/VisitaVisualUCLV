...
public class FCFActivity extends AppCompatActivity {
  String lenguage = "es";
  ...
  private void crearDialogoSlider() {
    ...
    builder.setTitle(getString(R.string.title_activity_fcf));
    webView.loadUrl("file:///android_asset/fslider/deporte_" + this.lenguage + ".html");
  ...
  protected void onCreate(Bundle paramBundle) {
    ...
    ((FloatingActionButton)findViewById(R.id.fab)).setOnClickListener(new View.OnClickListener() {
          public void onClick(View param1View) {
            FCFActivity.this.crearDialogoSlider();
          }
        });
    ...
    webSettings.setJavaScriptEnabled(true);
    webSettings.setDomStorageEnabled(true);
    this.myBrowser.loadUrl("file:///android_asset/info/fcf.html");
  }
}


/* Location:              C:\Users\Usuario\Videos\Visita Virtual a la UCLV\classes-dex2jar.jar\\uclv\dte\visitavirtualalauclv\FCFActivity.class
