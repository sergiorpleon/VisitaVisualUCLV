...
public class PIntermediario {
    PedagogicoActivity mContext;

    PIntermediario(PedagogicoActivity paramPedagogicoActivity) {
        this.mContext = paramPedagogicoActivity;
    }

    private void sendMessage(String paramString1, String paramString2) {
        Intent intent = new Intent("my-event-p");
    ...
    public void showToast(String paramString) {
        Toast.makeText((Context) this.mContext, paramString, 0).show();
    }
...
/* Location:              C:\Users\Usuario\Videos\Visita Virtual a la UCLV\classes-dex2jar.jar\\uclv\dte\visitavirtualalauclv\PIntermediario.class
